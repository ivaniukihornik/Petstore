# Project for testing Petstore API
https://petstore.swagger.io/
____

### To run the tests follow the steps below:
1. Clone repo with `git clone git@github.com:ivaniukihornik/Petstore.git` to your local space
2. Make sure you have installed python in your system
3. Create new project in IDE based on clonned repo or create python virtual environment and activate it
